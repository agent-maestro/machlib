...
theorem monostatic_falls_with_r4 (p_tx : Real) (gain : Real) (wavelength : Real) (rcs : Real) (range_m : Real)
    ...
    (h9 : (range_m >= R_MIN))
    (h10 : (range_m <= R_MAX)) :
    ((monostatic_received_power p_tx gain wavelength rcs range_m) >= (0.0 : Real)) := by
...
theorem bistatic_falls_with_rt2_rr2 (p_tx : Real) (g_tx : Real) (g_rx : Real) (wavelength : Real) (rcs_bistatic : Real) (range_tx : Real) (range_rx : Real)
    ...
    (h13 : (range_rx >= R_MIN))
    (h14 : (range_rx <= R_MAX)) :
    ((bistatic_received_power p_tx g_tx g_rx wavelength rcs_bistatic range_tx range_rx) >= (0.0 : Real)) := by
...
theorem max_range_increases_with_pt_pow_quarter (p_tx : Real) (gain : Real) (wavelength : Real) (rcs : Real) (p_min_detectable : Real)
    ...
    (h10 : (p_min_detectable <= (1.0 : Real))) :
    ((max_detection_range p_tx gain wavelength rcs p_min_detectable) >= (0.0 : Real)) := by
