...
noncomputable def WC_MAX : Real := (1.0 : Real)
...
theorem abrams_strength_decreases_with_wc (a_intercept : Real) (k_decay : Real) (water_cement_ratio : Real)
    (h1 : (a_intercept >= (0.0 : Real)))
    (h2 : (a_intercept <= A_MAX))
    (h3 : (k_decay >= (0.0 : Real)))
    (h4 : (k_decay <= K_MAX))
    (h5 : (water_cement_ratio >= WC_MIN))
    (h6 : (water_cement_ratio <= WC_MAX)) :
    ((compressive_strength a_intercept k_decay water_cement_ratio) >= (0.0 : Real)) := by
...
theorem aci_age_strength_factor_in_unit_interval (age_days : Real) (alpha : Real) (beta : Real)
    (h1 : (age_days >= (1.0 : Real)))
    (h2 : (age_days <= (1000.0 : Real)))
    (h3 : (alpha > (0.0 : Real)))
    (h4 : (alpha <= (50.0 : Real)))
    (h5 : (beta > (0.0 : Real)))
    (h6 : (beta <= (5.0 : Real))) :
    ((age_strength_factor age_days alpha beta) >= (0.0 : Real)) := by
