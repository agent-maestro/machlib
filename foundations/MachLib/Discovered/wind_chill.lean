...
noncomputable def V_MIN_KMH : Real := (0.0 : Real)
noncomputable def V_MAX_KMH : Real := (200.0 : Real)
noncomputable def T_MIN_F : Real := (0.0 : Real)
noncomputable def T_MAX_F : Real := (200.0 : Real)
noncomputable def RH_MIN : Real := (0.0 : Real)
...
theorem apparent_temperature_linear (temperature_c : Real) (vapor_pressure_hpa : Real) (wind_speed_ms : Real)
    (h1 : (temperature_c >= T_MIN_C))
    (h2 : (temperature_c <= T_MAX_C))
    (h3 : (vapor_pressure_hpa >= (0.0 : Real)))
    (h4 : (vapor_pressure_hpa <= (60.0 : Real)))
    (h5 : (wind_speed_ms >= (0.0 : Real)))
