...
noncomputable def DEPTH_MAX : Real := (1.0 : Real)
...
theorem shadow_pcf4_in_unit_interval (query_depth : Real) (sample0 : Real) (sample1 : Real) (sample2 : Real) (sample3 : Real) (bias : Real)
    ...
    (h11 : (bias >= (0.0 : Real)))
    (h12 : (bias <= BIAS_MAX)) :
    ((pcf_4tap query_depth sample0 sample1 sample2 sample3 bias) >= (0.0 : Real)) := by
  unfold pcf_4tap
...
theorem shadow_pcf9_in_unit_interval (query_depth : Real) (s0 : Real) (s1 : Real) (s2 : Real) (s3 : Real) (s4 : Real) (s5 : Real) (s6 : Real) (s7 : Real) (s8 : Real) (bias : Real)
    ...
    (h3 : (bias >= (0.0 : Real)))
    (h4 : (bias <= BIAS_MAX)) :
    ((pcf_9tap query_depth s0 s1 s2 s3 s4 s5 s6 s7 s8 bias) >= (0.0 : Real)) := by
  unfold pcf_9tap
  sorry  -- TODO: prove against MachLib foundations
