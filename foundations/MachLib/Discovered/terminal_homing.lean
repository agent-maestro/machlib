...
theorem tgo_inverse_proportional_to_closing (range_m : Real) (closing_speed : Real)
    ...
    (h3 : (closing_speed >= (1.0 : Real)))
    (h4 : (closing_speed <= V_MAX)) :
    ((time_to_go_estimate range_m closing_speed) >= (0.0 : Real)) := by
