...
| figure | value | source |
|---|---|---|
| theorems outside `Discovered/` | 8 038 | `python3 tools/count_theorems.py --scope core` |
| theorems in the Forge `@verify` corpus | 624 | the same command over `Discovered/` |
| `.lean` files under `MachLib/` | 1 085 | `git ls-files -- MachLib \| grep -c '\.lean$'` |
...
| modules reachable from the aggregator | 820 of 1 085 | `scripts/check_aggregator.sh` |
