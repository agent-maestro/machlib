...
PHASE_DEFS = [
    ...
    {
        "phase_id": "phase_11",
        "title": "Function-class frontier and D-finite executable slice",
        "goal": "Add function-class frontier records and execute the D-finite ODE subset locally.",
        "subjects": [
            "research/corpus: add MachLib EML function-class frontier",
            "test/corpus: add MachLib D-finite ODE certificate harness",
        ],
        "artifacts": ["function-class corpus", "function-class validator", "D-finite ODE harness"],
        "what_it_unlocked": "A next frontier for analytic/smooth/continuous local harnesses.",
        "limitations": ["D-finite roundtrip keeps expected draft-schema warning."],
    },
]
