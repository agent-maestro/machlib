const CLASSES: { value: string; label: string }[] = [
  { value: "121", label: "witnessed — a Mathlib term inhabits the interpreted type, kernel-checked" },
  ...
  { value: "31", label: "float-bridge — IEEE-754 facts with no model in ℝ, validated by measurement" },
];
    ...
    <section id="trust">
      <div className="container">
        ...
        <p className="section-lede">
          ...
          manifest listing all 167 is generated, and a gate fails if the
        ...
        <p className="flow-coda" style={{ marginTop: 28 }}>
          The 31 float-bridge axioms are a different kind of trust and are not
