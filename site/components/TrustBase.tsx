const CLASSES: { value: string; label: string }[] = [
  { value: "122", label: "witnessed — a Mathlib term inhabits the interpreted type, kernel-checked" },
    ...
    <section id="trust">
      <div className="container">
        ...
        <p className="flow-coda" style={{ marginTop: 28 }}>
          The 32 float-bridge axioms are a different kind of trust and are not
