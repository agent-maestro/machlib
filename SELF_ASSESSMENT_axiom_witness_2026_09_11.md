...
compiler, self-contained enough that nobody need read 257 909 lines of Lean.
...
corpus is ≈ 8 038 theorems outside its generated sub-corpus.
...
3. **32 float-bridge axioms cannot be witnessed even in principle.** Most assert that a concrete
